...
def parse_arguments():
    ...
    parser.add_argument("--no_pc_augment", default=True)
    ...
    parser.add_argument("--pad_size", type=int, default=16)     # 考虑每个单元格包含 16 个单元格内实例
    ...
    parser.add_argument("--fixed_embedding", default=True)
